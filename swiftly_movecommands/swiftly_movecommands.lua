...
commands:Register("afk", function(playerid, args, argsCount, silent)
    ...
    if team == TEAM_SPECTATOR then return player:SendMsg(MessageType.Chat, FetchTranslation("movecommands.PlayerAlreadyAFK")) end
    playermanager:SendMsg(MessageType.Chat, string.format(FetchTranslation("movecommands.MovedAFK"), playername))
